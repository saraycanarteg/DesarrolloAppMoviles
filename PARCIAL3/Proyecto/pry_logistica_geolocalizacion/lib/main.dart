...
void main() async {
  ...
  // Re-habilito la semilla para poder probar el pedido pendiente
  await seedDatosIniciales();

  final authDataSource = AuthRemoteDataSource();
  final authRepository = AuthRepositoryImpl(authDataSource);
  final loginUseCase = LoginUseCase(authRepository);
  final registrarUseCase = RegistrarUseCase(authRepository);
    ...
    MultiProvider(
      providers: [
        ChangeNotifierProvider(
          create: (_) => AuthViewModel(loginUseCase, registrarUseCase),
        ),
        ChangeNotifierProvider(
          create: (_) => PedidoViewModel(asignarRepartidorUseCase, observarTodosLosPedidosUseCase),
        ),
        ChangeNotifierProvider(
